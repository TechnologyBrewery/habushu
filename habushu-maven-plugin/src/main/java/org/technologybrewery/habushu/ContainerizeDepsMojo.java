...
public class ContainerizeDepsMojo extends AbstractHabushuMojo {
     ...
     * projects. If not set, defaults to everything except files in the directories "dist", "target", and ".venv".
     */
    @Parameter
    ...
    protected String dockerContext;
    ...
    protected Path getStagingPath() {
        return Path.of(stagingDirectory);
    }

    protected Path getDockerContextPath() {
        return Path.of(dockerContext);
    }

    protected void setStagingDirectory(String stagingDirectory) {
        this.stagingDirectory = stagingDirectory;
    }

    protected void setDockerContext(String dockerContext) {
    ...
    protected void performDockerfileUpdateForVirtualEnvironment(Path targetProjectPath) {
        Path outputDir = getDockerContextPath().relativize(getStagingPath());
