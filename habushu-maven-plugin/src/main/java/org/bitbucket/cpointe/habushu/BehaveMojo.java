...
public class BehaveMojo extends AbstractHabushuMojo {
     ...
     */
    @Parameter(property = "pythonTestDirectory", required = true, defaultValue = "${project.build.directory}/"
            + AbstractHabushuMojo.DEFAULT_TEST_STAGING_FOLDER)
    ...
    private void verifyBehaveExistsInEnvironment() {
        ...
        if (logger.isDebugEnabled()) {
            // Check the environment dependency list and output results for
            // logging
