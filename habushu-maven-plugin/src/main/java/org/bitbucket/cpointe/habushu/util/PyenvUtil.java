...
public final class PyenvUtil {

    private static final String PYENV = "pyenv";
    ...
    public static void checkPyEnvInstall(File workingDirectory) {
        ...
        try {
            ...
            throw new HabushuException(
                    "'pyenv' is not currently installed! Please install pyenv and try again. Checkout https://github.com/pyenv/pyenv for more.");
        }
    }
    ...
    /**
     * Writes commands to install python with pyenv with a patch that fixes a compilation error.
     * 
     * @param pythonVersion
     * @param changeVersionScript
     */
